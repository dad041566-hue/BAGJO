    ...
    <div className="page-canvas">
      ...
      <section className="page-section">
        <div className="site-container-wide">
          ...
          <aside className="mt-6 rounded-[20px] border border-[#E7E0D5] bg-white p-5 sm:p-6" aria-label="백조 Audit 안내">
            <p className="break-keep text-[15px] leading-[1.8] text-[#6F766F] md:text-[14px] md:leading-[1.7]">
              백조 Audit은 브랜드가 제공한 자료와 공개 정보를 바탕으로 한 큐레이션 기준입니다.
